...
def find_contours(file_name, tc_name):
    ...
    segments = 	cv2.ximgproc.SuperpixelLSC.getNumberOfSuperpixels(image, region_size=20, ruler=4.0)
...
if __name__ == "__main__":
    ...
    # paramters: 
    directory_path = "C:/Users\TOSHIBA\Desktop\clouds backup\sep 2019" # change it to wished path
